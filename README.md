...
* **RC6 encryption FPGA design**
  ...
  * 📂 [Link to source files and testbenches](./Projects/Hardware design/RC6_ENCRYPTION)
...
* **Diffie-Hellman key exchange on GF(2^79) Elicptic curves in FPGA**
  ...
  * **Third-party modules:** RS232.v
  * 📂 [Link to source files and testbenches](./Projects/Hardware design/ECDH_KEY_EXCHANGE)
...
* **RSA digital signature in FPGA using 256b key**
  ...
  * **Third-party modules:** RS232.v
  * 📂 [Link to source files and testbenches](./Projects/Hardware design/RSA_DIGITAL_SIGNATURE)
...
* 📂 [Link to source code (src) and architecture](./Projects/Embedded system application)
...
* **Night lamp charged by photovoltaic panel with energy storage**
  ...
  * 🖼️ [3D render preview](./Projects/PCB design/PCB_3D.png)
  * 📄 [Vector schematic in PDF](./Projects/PCB design/Schema.pdf)
  * 📂 [Link to KiCad project files](./Projects/PCB design)